...
```bash
pm-copilot baseline show                    # 전체
pm-copilot baseline show --channel meta     # 채널별
pm-copilot baseline sources                 # 출처 목록
```
...
```bash
pm-copilot baseline compare --channel meta --metric roas --value 2.1
```
